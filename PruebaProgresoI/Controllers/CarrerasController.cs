...
namespace PruebaProgresoI.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public CarrerasController(PruebaProgresoIContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CarreraID,NombreCarrera,campus,Nsemestres")] Carrera carrera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarreraID,NombreCarrera,campus,Nsemestres")] Carrera carrera)
        {
